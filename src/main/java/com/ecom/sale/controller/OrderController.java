...
public class OrderController {
    ...
    @Operation(
            ...
            description = "Creates a new order based on the provided product IDs and quantities",
            responses = {
    ...
    @Operation(
            ...
            description = "Updates an existing order by ID. Old items will be replaced with new ones.",
            responses = {
    ...
    @Operation(
            ...
            description = "Deletes an order by ID. If order is NEW, product quantities are restored.",
            responses = {
    ...
    @Operation(
            ...
            description = "Cancels an order by ID and restores product stock.",
            responses = {
